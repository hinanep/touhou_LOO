...
@export var particle_scale_min: Array[float] = [1.0, 1.0, 1.0, 1.0]
@export var particle_scale_max: Array[float] = [1.0, 1.0, 1.0, 1.0]
...
func set_particle_scale(sc: float) -> void:
