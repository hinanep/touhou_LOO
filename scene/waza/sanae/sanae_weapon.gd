...
func _ready():
	...
	print("sanae_ready")
	bullet_small_pre = PresetManager.getpre("bullet_sanae_small")
	bullet_mid_pre = PresetManager.getpre("bullet_sanae_mid")
	bullet_big_pre = PresetManager.getpre("bullet_sanae_big")
	super._ready()
