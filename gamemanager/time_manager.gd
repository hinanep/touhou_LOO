extends Node
@onready var firsttext: RichTextLabel = $time_ui/timetext/first
@onready var secondtext: RichTextLabel = $time_ui/timetext/second
...
var boss_cardtime: int = 0
var pause_boss_hud_time: bool = false
